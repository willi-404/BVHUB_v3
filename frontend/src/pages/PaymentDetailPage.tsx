...
import { CheckCircle2, Copy, Download, Landmark, ReceiptText } from "lucide-react"
...
import { createEpcPayload, downloadEpcPng, formatMoney } from "../features/payments/paymentUtils"
...
export default function PaymentDetailPage() {
  ...
  const epc = useMemo(() => {
    ...
    try { return { payload: createEpcPayload(payment.data) } } catch { return null }
  }, [payment.data])
