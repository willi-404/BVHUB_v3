  ...
  return (
    <main className="min-h-full bg-background px-4 py-6 md:px-8">
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-6">
        <Breadcrumb><BreadcrumbList><BreadcrumbItem><BreadcrumbLink href="/home">{t("nav.home")}</BreadcrumbLink></BreadcrumbItem><BreadcrumbSeparator /><BreadcrumbItem><BreadcrumbPage>{t("admin.memberCardScanner.breadcrumb")}</BreadcrumbPage></BreadcrumbItem></BreadcrumbList></Breadcrumb>
